...
void Desentramado_Entrada_2 (void)
{
	...
	if(aux!=-1)
	{
		...
		{
			case estado0:
				if(aux=='E')//!< Actualizo codigo que ingreso
				{
					estado=estado1;
				}
				if(aux=='S')//!< Actualizo codigo que salio
				{
					estado=estado2;
				}
				if(aux=='H')//!< Actualizo Hora
				{
					estado=estado3;
				}
				if(aux=='F')//!< Actualizo fecha
				{
					estado=estado4;
				}
				if(aux=='I')//!< Actualizo codigo inhabilitado
				{
					estado=estado5;
				}
				if(aux=='L')//!< Primer paso Actualizacion
				{
					estado=estado6;
				}
				if(aux=='B')//!< Confirmar Actualizacion
				{
					estado=estado7;
				}
				break;
